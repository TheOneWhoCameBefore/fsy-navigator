...
// Import the Selection Dashboard component
...
const App = () => {
    ...
    const [currentPage, setCurrentPage] = useState('calendar'); // 'calendar' or 'selection'
        ...
        <div id="calendar-container" className="fixed inset-0 w-screen h-screen box-border flex flex-col font-sans text-gray-800 bg-gray-100">
            ...
            {isFilterModalOpen && (
                <div 
                    ...
                    onClick={(e) => e.target === e.currentTarget && handleFilterModalCancel()}
                >
                    <div className="bg-white rounded-lg shadow-2xl max-w-5xl w-full my-4 sm:my-8 max-h-[calc(100vh-2rem)] sm:max-h-[calc(100vh-4rem)] overflow-hidden">
                        ...
                        <div className="p-4 sm:p-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 12rem)' }}>
                            ...
                            <div className="flex gap-2 justify-end pt-3 border-t border-gray-200">
                                <button 
                                    onClick={handleFilterModalCancel} 
                                    className="px-4 py-2 border border-gray-300 bg-white rounded-md cursor-pointer transition-all duration-200 text-sm hover:bg-gray-100 hover:text-gray-800 hover:border-gray-400"
                                >
                                    Cancel
                                </button>
                                <button 
                                    onClick={handleFilterModalClose} 
                                    className="px-4 py-2 border border-blue-600 bg-blue-600 text-white rounded-md cursor-pointer transition-all duration-200 text-sm hover:bg-blue-700 hover:border-blue-700"
                                >
                                    Apply Filters
                                </button>
                            </div>
            ...
            {isDutiesSummaryModalOpen && (
                <div 
                    className="fixed inset-0 bg-black bg-opacity-50 z-[2000] flex items-start justify-center p-2 sm:p-4 overflow-y-auto" 
                    onClick={(e) => e.target === e.currentTarget && setIsDutiesSummaryModalOpen(false)}
                >
                    <div className="bg-white rounded-lg shadow-2xl max-w-5xl w-full my-4 sm:my-8 max-h-[calc(100vh-2rem)] sm:max-h-[calc(100vh-4rem)] overflow-hidden">
                        <div className="flex justify-between items-center p-4 sm:p-6 border-b bg-gray-50">
                            <h2 className="text-lg sm:text-xl font-bold text-gray-800 m-0">AC Role Duties Summary</h2>
                            <button 
                                onClick={() => setIsDutiesSummaryModalOpen(false)} 
                                className="text-gray-500 hover:text-gray-700 text-2xl font-bold p-1 hover:bg-gray-200 rounded"
                            >
                                ×
                            </button>
